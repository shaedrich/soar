...
func init() {
	...
	TestSQLs = []string{
		...
		// https://github.com/yassineim/soar/issues/47
		...
		// https://github.com/yassineim/soar/issues/17
		"create table hello.t (id int unsigned);",

		// https://github.com/yassineim/soar/issues/146
		"select * from tb where data >= '';",

		// https://github.com/yassineim/soar/issues/163
